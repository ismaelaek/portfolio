    ...
    return (
        <div id="about" className=" p-5 mx-10 rounded-xl bg-white text-center shadow-md" style={{ position: "absolute", top: -100, left: 0, zIndex: 10 , width: 'auto'}}>
            ...
            <p className=" text-lg text-justify">
                A highly motivated and ambitious student at Specialized Institute Of Applied Technology NTIC,
                ...
                using Python, coupled with proficiency in ReactJS, Larvel and 
                MongoDB, I am eager to apply my knowledge and further develop my 
